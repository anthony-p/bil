...
<!--
	...
	$(document).ready(function()
	{
		...
		$('#body_sub_title').html( "<img src=\"../pics/icons/book.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"\" style=\"margin-right: 5px;\"> Report: Refer URLs" ) ;
...
<?php include_once( "./inc_header.php" ) ?>
		...
		<div id="overview_day_chart" style="margin-top: 10px;">
			...
			<div id="overview_data_container">
				<table cellspacing=0 cellpadding=0 border=0 width="100%">
				<tr>
					<td><div id="td_dept_header">Top 25 Refer URLs</div></td>
				</tr>
				<tr>

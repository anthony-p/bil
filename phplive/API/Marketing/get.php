<?php
						...
						$marketid )
	{
		...
		$query = "SELECT * FROM p_marketing WHERE marketID = $marketid" ;
		database_mysql_query( $dbh, $query ) ;
						...
						$marketid )
	{
		...
		$query = "SELECT * FROM p_market_c WHERE marketID = $marketid AND sdate = $sdate" ;
		database_mysql_query( $dbh, $query ) ;
						...
						$marqid )
	{
		...
		$query = "SELECT * FROM p_marquees WHERE marqID = $marqid" ;
		database_mysql_query( $dbh, $query ) ;

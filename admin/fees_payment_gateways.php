...
else
{
	...
	{
		$active_pg_message .= '<br><br>Important: You (and your sellers if direct payment is enabled) <br>'.
			'will need two separate merchant accounts in order to use both PPB and PPA for the following payment gateways: <br>'.
			' [ <font color="#EEEE00">2Checkout</font> ] '.
			' [ <font color="#EEEE00">Worldpay</font> ] '.
			' [ <font color="#EEEE00">Ikobo</font> ] '.
			' [ <font color="#EEEE00">Authorize.net</font> ] '.
			' [ <font color="#EEEE00">Google Checkout</font> ] ';
	}

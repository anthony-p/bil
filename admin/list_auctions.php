		...
		while ($item_details = $db->fetch_array($sql_select_items))
		{
			...
			$auctions_content .= '<tr class="' . $background . '"> '.
	      	'	<td valign="top">' . $item_details['name'] . 
				(($item_details['winner_id']) ? ' <img src="images/item_sold.gif" border="0" alt="' . MSG_ITEM_WAS_SOLD . '" align="absmiddle">' : '') . ' ' . $item->listed_in($item_details) .	      	
	      	'		<br>' .
            ...
            '		[ <a href="list_auctions_bids.php?auction_id=' . $item_details['auction_id'] . '">Bid</a> ]'.

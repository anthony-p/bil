...
//	var $SelectLimit = TRUE;
	...
	function __construct() {
		...
		// sales by month
		$this->sales_by_month = new crChart('sales_by_month', 'sales by month', 'sales_by_month', 'sales by month', 'np-name', 'Sales', '', 1, 'SUM', 550, 440);
		$this->sales_by_month->SqlSelect = "SELECT `np-name`, '', SUM(`Sales`) FROM ";
		$this->sales_by_month->SqlGroupBy = "`np-name`";
...
$Page->sales_by_month->SetChartParms(array(array("type", "1", FALSE),
...
$Page->sales_by_month->SetChartParms(array(array("shownames", "1"),
	array("showvalues", "1"),
...
ewr_SortChartData($Page->sales_by_month->Data, 0, "");

...
/**
 * MySQL API for PHP Report Maker 5
 ...
 */
$PHPReportMaker_vers = 'PHP Report Maker 6 (C) 2007-2012 e.World Technology Limited';
define('ADODB_FETCH_DEFAULT', 0);
define('ADODB_FETCH_NUM', 1);
define('ADODB_FETCH_ASSOC', 2);
define('ADODB_FETCH_BOTH', 3);
define('EWR_USE_MYSQLI', FALSE && extension_loaded("mysqli"), TRUE);

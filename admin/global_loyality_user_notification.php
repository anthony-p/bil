...
if($activity)
{
    ...
    $text_message = 'Thank you for using Bring It Local to support your community. Your most recent act of consumer disobedience has earned you %1$s points for %2$s.
        <br>
        You now have a total of %3$s points. When you reach %4$s points we\'ll give you a voucher for a local merchant.';
    ...
    send_mail('markmainsail@gmail.com', 'User loyalty program', $text_message,
        'support@bringitlocal.com', null, null, $send);
}
...
if($sum_points_awarded > $points_to_win){
    ...
    send_mail('$user_details['email']', 'Users loyalty program', $text_message,
        'support@bringitlocal.com', null, null, $send);
}
?>
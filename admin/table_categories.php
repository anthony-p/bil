		...
		if ($category_details['parent_id']==0)
		{
			$categories_page_content .= '<td align="center">' .
				...
				(($table_name == 'categories') ?  
					('<td align="center">' .
					(($category_details['user_id']==0) ? '<input name="minimum_age[]" type="text" id="minimum_age[]" size="8" value="' . $category_details['minimum_age'] . '">' : '<input type="hidden" name="minimum_age[]" value="">') . '</td>') : '').
				'	<td align="center">' .

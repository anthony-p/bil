      ...
      <tr valign="top">
         <td align="center"><table width="100%" border="0" cellpadding="3" cellspacing="1">
               <tr class="c4">
                  ...
                  <? if ($parent_id==0) { ?>
                  <td width="150" align="center"><?=GMSG_CUSTOM_SKIN;?></td>
                  <? if ($table != 'reverse') { ?>
                  <td width="60" align="center"><?=AMSG_MIN_AGE_YEARS;?></td>
                  <? } ?>
                  <td width="60" align="center"><?=AMSG_INDIVIDUAL_FEES;?></td>
                  <? } ?>
                  <? if ($table != 'reverse') { ?>
                  <td width="60" align="center"><?=AMSG_HIDDEN;?></td>
                  <? } ?>
                  <td width="60" align="center"><?=AMSG_DELETE;?></td>
               </tr>

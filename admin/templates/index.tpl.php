   ...
   <tr>
      <td valign="top" width="50%">
         ...
         <table width="100%" border="0" cellpadding="2" cellspacing="2" class="fside">
            <tr>
               <td width="100%" class="menulink">
               	<img src="images/a.gif" align="absmiddle" vspace="2"> <a href="pps_integration.php"><?=AMSG_PPB_PPA_INTEGRATION;?></a>
               	<hr>
                  ...
                  <img src="images/a.gif" align="absmiddle" vspace="2"> <a href="payment_option_details.php?page=paypal"><?=AMSG_PAYMENT_OPTION_DETAILS;?></a> </td>
            </tr>
         </table>
         <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
         ...
         <table width="100%" border="0" cellpadding="2" cellspacing="2" class="fside">
            <tr>
               <td width="100%" class="menulink">
                  ...
                  <img src="images/a.gif" align="absmiddle" vspace="2"> <a href="enable_disable.php?page=buyer_create_invoice"><?=AMSG_ENABLE_BUYER_CREATE_INVOICE;?></a> </td>
            </tr>
         </table>
         <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
         ...
         <table width="100%" border="0" cellpadding="2" cellspacing="2" class="fside">
            <tr>
               <td width="100%" class="menulink">
                  ...
                  <img src="images/a.gif" align="absmiddle" vspace="2"> <a href="download_csv_reports.php">Amazon Reports Export</a> <br>
                  <img src="images/a.gif" align="absmiddle" vspace="2"> <a href="vendor_clickthrough_reports.php">Vendors Click Through Reports</a> <br>
                  ...
                  <img src="images/a.gif" align="absmiddle" vspace="2"> <a href="refund_requests.php"><?=AMSG_REFUND_REQUESTS;?></a><br>
		<img src="images/a.gif" align="absmiddle" vspace="2"> <a href="giveback_points.php">Giveback points conversion rate</a><br>
		<img src="images/a.gif" align="absmiddle" vspace="2"> <a href="giveback_invoices.php"><?=AMSG_GIVEBACK_INVOICES;?></a>
                  <!--
      ...
      <td width="50%" valign="top">
            ...
            <tr>
               <td width="100%" class="menulink">
                  ...
                  <img src="images/a.gif" align="absmiddle" vspace="2"> <a href="list_site_users.php"><?=AMSG_USERS_MANAGEMENT;?></a> <br>
                   <img src="images/a.gif" align="absmiddle" vspace="2"> <a href="list_np_users.php">np-Users</a> <br>
         ...
         <table width="100%" border="0" cellpadding="2" cellspacing="2" class="fside">
		   ...
		   <img src="images/a.gif" align="absmiddle" vspace="2"> <a href="content_global_partners_management.php"><?=AMSG_SITE_PARTNERS_MANAGEMENT;?></a> <br>		  
                  <img src="images/a.gif" align="absmiddle" vspace="2"> <a href="content_language_files.php"><?=AMSG_EDIT_SITE_LANGUAGE_FILES;?></a> <br>
                  <img src="images/a.gif" align="absmiddle" vspace="2"> <a href="content_section.php?page=announcements"><?=AMSG_EDIT_MEMBERS_ANNOUNCEMENTS;?></a> </td>
            </tr>
         </table>
         <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
         ...
         <table width="100%" border="0" cellpadding="2" cellspacing="2" class="fside">
            <tr>
               <td width="100%" class="menulink">
                  ...
                  <img src="images/a.gif" align="absmiddle" vspace="2"> <a href="http://www.xe.com/ucc/" target="_blank"><?=AMSG_CURRENCY_CONVERTER;?></a><br>
                   <img src="images/a.gif" align="absmiddle" vspace="2"> <a href="widget.php"><? echo "Widget"; ?></a>
               </td>

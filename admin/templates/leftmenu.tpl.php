	...
	<tr>
		<td colspan="2">
			<div id="exp1" style="padding: 5px;">
				...
				<div class="fsidew">
               <div class="alink"><a href="pps_integration.php"><?=AMSG_PPB_PPA_INTEGRATION;?></a></div>
			...
			<? if (
				...
				eregi("pps_integration.php",$_SERVER['PHP_SELF'])) { } 
			else {?>
		...
		<td colspan="2">
			<div id="exp5" style="padding: 5px;">
				...
				<div class="fsidew">
                    ...
                    <div class="alink"><a href="list_np_users.php">np-Users</a></div>
		...
		<td colspan="2">
			<div id="exp10" style="padding: 5px;">
				...
				<div class="fsidew">
					...
					<div class="alink"> <a href="giveback_points.php"><?=AMSG_GIVEBACK_CONVERSION;?></a></div>
					<div class="alink"> <a href="giveback_invoices.php"><?=AMSG_GIVEBACK_INVOICES;?></a></div>

...
<tr class="c3">
      <td colspan="2"><?=AMSG_GIVEBACK_POINTS;?></td>
   </tr>
<tr class="c1">
      <td width="50%"><img src="images/a.gif" align="absmiddle" /> <a href="fees_management.php?category_id=<?=$category_id;?>&fee_column=giveback&tiers=1"><?=AMSG_GIVEBACK_POINTS;?></a> </td>

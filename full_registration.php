...
define ('IN_SITE', 1);
$GLOBALS['body_id'] = "full_register";

(string) $page_handle = 'full_register';
...
else
{
    ...
    else
    {
        ...
        if (!$form_submitted)
        {
            $template->set('register_post_url', 'full_registration.php');
            ...
            $template_output .= $template->process('full_registration.tpl.php');
        }
    }

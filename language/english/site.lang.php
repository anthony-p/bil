...
define ('MSG_REGISTRATION', 'New User Registration  <br>* = required fields');
...
define ('MSG_PARTNER_NAME', 'Sort by name');
...
define ('MSG_AFFILIATES', 'Buy Global - our shopping partners');
define ('MSG_BROWSE_AFFILIATES', 'Buy Global - browse all our shopping partners');
define ('MSG_FEATURED_AFFILIATES', 'Buy Global - featured shopping partners');
...
define ('MSG_MM_WANTED_ADS', 'Want Ads');
...
define ('MSG_BTN_WANTED_ADS', 'Want Ads');
...
define ('MSG_FEATURED_AUCTIONS', 'Local Auctions');
...
define ('MSG_LIVE_WANT_ADS', 'live Want Ads');
...
define ('MSG_MM_OPEN_WANTED_ADS', 'Open Want Ads');
define ('MSG_MM_CLOSED_WANTED_ADS', 'Closed Want Ads');
...
define ('MSG_LOCALSTORES_DIRECTORY', 'Directory of Local Stores That Support Us');
...
define ('MSG_SEARCH_WANTED_ADS', 'Search Want Ads');
define ('MSG_SEARCH_PARTNER_ADS', 'Search Shopping Partners');
define ('MSG_SEARCH_LOCALWANTED_ADS', 'Search Community Want Ads');
...
define ('MSG_RECENTLY_LISTED_WANTED_ADS', 'Recently Listed Want Ads');
...
define ('MSG_LOCALSTORE_SEARCH', 'Search Local Stores That Support Us');
...
define ('MSG_SEARCH_IN_A_CATEGORY', 'Search by name or keyword');
...
define ('MSG_ALL_LOCALSTORES', 'All Local Stores That Support Us');
define ('MSG_FEATURED_STORES', 'Featured Stores');
define ('MSG_FEATURED_LOCALSTORES', 'Featured Local Stores That Support Us');
...
define ('MSG_GET_VERIFIED_EXPL_2', 'You can opt to become a verified seller on Bring It Local. <br><br>Verification of your account details is important because our site promotes community and transparency.
<br><br>If you choose to become verified, Bring It Local will attempt to manually confirm the details of your account - your email, telephone and address. 
');
define ('MSG_GET_VERIFIED_EXPL_3', 'Please note:
<ul>
<li>The fee for verification is currently $15.00.  Half of this fee goes back to the nonprofit you support.</li>
<li>Confirmation of your verified status will appear next to your profile and username throughout the site.</li>
<li>It may take several days before your verification is complete and your verified badge appears on the site.</li>
<li><br><strong>Important: </strong>If you have already requested verification and paid the fee DO NOT choose "get verified" below. Click on "Skip Verification".</li>
</ul>');
...
define ('MSG_DATE_OF_BIRTH_EXPL', 'Enter your birth date in the fields above. You must be 18 or over to register on this site.');
...
define ('MSG_UPLOADED_FILES_EXPL', 'The files above have been uploaded. You can remove them by clicking on the checkbox
...
define ('MSG_BTN_SHOP_PARTNERS', 'Online Retailers');
define ('MSG_BTN_COUPONS', 'Local Offers');

define ('MSG_AUCTIONS_SEARCH', 'Search Auctions');
define ('MSG_CLASSIFIEDS_SEARCH', 'Search Classifieds');
define ('MSG_FEATURED', 'Featured');
define ('MSG_RECENTLY_LISTED', 'Recently Listed');
define ('MSG_POPULAR_ADS', 'Popular Ads');
define ('MSG_ENDING_SOON_AUCTIONS_B', 'Ending Soon Auctions');
...
define ('MSG_PAYMENT_STATUS', 'Payment Status');
define ('MSG_ORDER_STATUS', 'Order Status');
define ('MSG_FILTER_CARTS', 'Filter Transactions');
define ('MSG_NONE_CART', '-- none --');
define ('MSG_CART_DELETED_SUCCESS', 'The shopping cart has been deleted successfully.');
define ('MSG_NO_ACTIVE_SHOPPING_CARTS', 'Shopping cart empty.');
define ('MSG_SC_TAX', 'Add Tax');
define ('MSG_SC_TAX_EXPL', 'If this setting is enabled, tax will be applied to your shopping carts (if the buyers are eligible to pay tax).');
define ('MSG_CART_SUBTOTAL', 'Cart Subtotal');
define ('MSG_APPLY_INSURANCE', 'Apply Insurance');
define ('MSG_LOGIN_TO_CALC_SHIPPING', 'Please login first');
define ('MSG_CHECKOUT_CONFIRMATION', 'Are you sure you want to checkout?');
define ('MSG_ERROR_SELLER_CART_OWNER', 'Error: you cannot purchase your own items.');
define ('MSG_STORE_SHIPPING_GLOBAL', 'Global Shipping Costs');
define ('MSG_STORE_SHIPPING_GLOBAL_EXPL', 'If this option is checked, your shipping costs will apply to all buyers, regardless of their location.<br>
Otherwise, the shipping costs will apply only if the buyer resides in the same country as you, and for buyers from abroad, you will need to apply the 
postage costs manually.');
define ('MSG_SHOP_DIRECT_PAYMENT_METHODS_EXPL', 'Select one or more direct payment options if you want to be able to offer your buyers the 
possibility to purchase the shopping cart items directly through the site.');
define ('MSG_SHIPPING_CALC_MANUALLY', 'Shipping will be calculated manually');
define ('MSG_CHECKOUT_MANUAL_SHIPPING', 'The shipping costs will be calculated manually, and will be attached to the invoice the seller will create.');
define ('MSG_CHECKOUT_NO_INT_SHIPPING', 'The seller doesn\'t offer internation shipping.');
define ('MSG_CART_PURCHASE_SUCCESS_EXPL', 'You have successfully purchased the items from your shopping cart.<br>
Thank you for your business.');
define ('MSG_CART_ITEMS', 'Cart Items');
define ('MSG_SINGLE_PURCHASES', 'Single Purchases');
define ('MSG_FILTER_BY', 'Filter By');
define ('MSG_MM_PURCHASED_CARTS', 'Won Store Items');
define ('MSG_MM_CART_INVOICES', 'Store Items Invoices');
define ('MSG_MM_SOLD_CARTS', 'Sold Store Items');
define ('MSG_CARTS', 'carts');
define ('MSG_SC_DETAILS', 'Shopping Cart Details');
define ('MSG_SC_ID', 'Cart ID');
define ('MSG_VIEW_CART_INVOICE', 'View Cart Invoice');
define ('MSG_RESEND_CART_INVOICE', 'Resend Cart Invoice');
define ('MSG_SEND_CART_INVOICE', 'Send Cart Invoice');
//define ('MSG_SHOPPING_CART_SALE', 'Shopping Cart Sale');
define ('MSG_ERROR_CART_NOT_AVAILABLE', 'Error: The cart you have selected is no longer available.');
define ('MSG_SC_DP_PAID_EXPL', 'You have paid with direct payment for the contents of this cart.');
define ('MSG_ERROR_SC_SALE_PAYMENT', 'Error: The sale fee cannot be paid for the shopping cart selected.');
define ('MSG_TO_PAY_FOR_SC_SALE_FEE', 'to pay for the shopping cart sale commission.');
define ('MSG_THE_SC_SALE', 'The shopping cart sale');
define ('MSG_EDIT_POSTAGE_EXPL', 'Important: The invoice will be automatically created when the "Update Postage" button will be clicked.');
define ('MSG_UPDATE_POSTAGE_CONFIRMATION', 'Are you sure you want to update this cart`s postage? Upon clicking this button, the cart invoice will also be generated.');
define ('MSG_CART_INVOICE_RESENT_SUCCESSFULLY', 'The shopping cart invoice notification has been resent to the buyer successfully.');
define ('MSG_REMOVE', 'Remove');
define ('MSG_REMOVED_FROM_CART_SUCCESS', 'successfully removed from the shopping cart.');
define ('MSG_CART_QUANTITY_UPDATE_SUCCESS', 'quantity updated successfully.');
define ('MSG_CART_QUANTITY_FAIL', 'error - not enough quantity available.');
define ('MSG_CART_ITEM_ADD_SUCCESS', 'item added to cart successfully');
define ('MSG_SELECT_CART', 'Select Transaction');
define ('MSG_CHECKOUT_SUCCESS', 'Checkout Successful');
define ('MSG_UPDATE_CART', 'Update Cart');
define ('MSG_CHECKOUT', 'Checkout');
define ('MSG_ITEM_NAME', 'Item Name');
define ('MSG_GUEST', 'Guest');
define ('MSG_SHOPPING_CART_EMPTY', 'This shopping cart is empty.');
define ('MSG_SHOPPING_CART_UPDATED', 'The shopping cart has been updated successfully.');
define ('MSG_SHIPPING_LOCATION_UNSUPPORTED_WARNING_SC', '<b>Error</b>: Purchase is not possible because you are not in a location supported by the seller.');
...
define ('MSG_DRAFTS_CAPMAIGNS', 'Draft Campaigns');

...
define("EWRPT_PROJECT_NAME", "project10", TRUE); // Project Name
define("EWRPT_PROJECT_VAR", "project10", TRUE); // Project Var
...
define("EWRPT_RANDOM_KEY", 'Q8ws781qjyzpq3iH', TRUE); // Random key for encryption
define("EWRPT_PROJECT_STYLESHEET_FILENAME", "phprptcss/project10.css", TRUE); // Project stylesheet file name

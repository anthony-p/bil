...
if ($_GET["sv1_username"] == $HTTP_SESSION_VARS[probid_username]){
...
<?php if ($onebar->Export == "") { ?>
&nbsp;&nbsp;<a href="<?php echo $onebar_summary->ExportExcelUrl ?>&sv1_username=<?=$_SESSION[probid_username]?>&sv_invoice_date=<?=$_SESSION[sv_onebar_invoice_date]?>"><?php echo $ReportLanguage->Phrase("ExportToExcel") ?></a>
&nbsp;&nbsp;<a href="<?php echo $onebar_summary->ExportWordUrl ?>&sv1_username=<?=$_SESSION[probid_username]?>&sv_invoice_date=<?=$_SESSION[sv_onebar_invoice_date]?>"><?php echo $ReportLanguage->Phrase("ExportToWord") ?></a>
...
<input type="hidden" name="sv1_username" id="sv1_username" size="30" maxlength="255" value="<?php echo ewrpt_HtmlEncode($onebar->username->SearchValue) ?>"<?php echo ($onebar_summary->ClearExtFilter == 'onebar_username') ? " class=\"ewInputCleared\"" : "" ?>>
</span>
...
class cronebar_summary {
	...
	function LoadDefaultFilters() {
		...
		*/
		...
		// Field username
		$this->SetDefaultExtFilter($onebar->username, "=", $sv1_username, 'AND', "=", NULL);

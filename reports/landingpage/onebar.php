...
//	var $SelectLimit = TRUE;
	...
	function cronebar() {
		...
		// Chart1
		$this->Chart1 = new crChart('onebar', 'onebar', 'Chart1', 'Chart1', 'np_name', 'points', '', 5, 'SUM', 160, 300);
...
$onebar->Chart1->SetChartParam("shownames", "0", TRUE); // Show names
$onebar->Chart1->SetChartParam("showvalues", "0", TRUE); // Show values
...
<!-- Search form (begin) -->
<form name="fonebarsummaryfilter" id="fonebarsummaryfilter" action="onebar.php" class="ewForm" onsubmit="return onebar_summary.ValidateForm(this);">
	
		<?php echo $onebar->np_name->FldCaption() ?>
		<?php echo $ReportLanguage->Phrase(""); ?>
<input type="hidden" name="so1_np_name" id="so1_np_name" value="=">

<input type="hidden" name="sv1_np_name" id="sv1_np_name" size="100" maxlength="255" value="<?php echo ewrpt_HtmlEncode($onebar->np_name->SearchValue) ?>"<?php echo ($onebar_summary->ClearExtFilter == 'onebar_np_name') ? " class=\"ewInputCleared\"" : "" ?>>
...
<br>			<input type="Submit" name="Submit" id="Submit" value="<?php echo $ReportLanguage->Phrase("Search") ?>">
...
class cronebar_summary {
	...
	function LoadDefaultFilters() {
		...
		*/
#$sv1_np_name="Fairfax High School";
		// Field np_name
	...
	function ShowFilterList() {
		...
		if ($sExtWrk <> "" || $sWrk <> "")
			$sFilterList .= $onebar->np_name->FldCaption() . "";
		if ($sExtWrk <> "")

...
define("EWRPT_PROJECT_NAME", "landingpage", TRUE); // Project Name
define("EWRPT_PROJECT_VAR", "landingpage", TRUE); // Project Var
...
// Database connection
define("EWRPT_CONN_HOST", $db_host, TRUE);
define("EWRPT_CONN_PORT", 3306, TRUE);
define("EWRPT_CONN_USER", $db_username, TRUE);
define("EWRPT_CONN_PASS", $db_password, TRUE);
define("EWRPT_CONN_DB",$db_name, TRUE);
...
define("EWRPT_RANDOM_KEY", '81NY036_hmyR843h', TRUE); // Random key for encryption
define("EWRPT_PROJECT_STYLESHEET_FILENAME", "phprptcss/landingpage.css", TRUE); // Project stylesheet file name

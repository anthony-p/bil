...
echo "limit results to <input type = 'text' name='limitresults' value='5' id='limitresults' size='4'/> organizations";
echo "<br><input type='button' value='Search' onClick='doHttpRequest3();'>";

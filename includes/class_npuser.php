...
//    echo '</pre>';
    ...
    include ('includes/npprocedure_frmchk_edit_campaign.php'); /* Formchecker for user creation/edit */
...
//                var_dump('<br>update:<br> ');
//                var_dump($pitch_update_query);
...
//            var_dump('<br>delete:<br>');
//            var_dump($pitch_delete_query);

...
class npbanner extends npdatabase
{
	...
	function display_banner($advert_row, $in_admin = false)
	{
		...
		{
			$display_output = '<table cellpadding="1" cellspacing="0"><tr><td align="center"><a href="npbanner_click.php?advert_id=' . $advert_row['advert_id'] . '" target="_blank">'.

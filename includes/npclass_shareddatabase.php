...
class npsharedatabase extends npdbshare_main
{


function count_ssorgrows($table_name, $condition = null, $debug = false)
	...
	function get_sql_row ($query, $debug = true)
	{

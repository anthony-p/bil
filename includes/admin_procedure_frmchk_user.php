...
////	$fv->check_box($frmchk_details['phone_b'], MSG_PHONE_B, array('field_empty', 'field_html', 'is_phone'));
//}
//else if (IN_ADMIN && isset($frmchk_details['phone']) && $frmchk_details['phone'])
//{
//	$fv->check_box($frmchk_details['phone'], MSG_PHONE, array('field_html', 'is_phone'));
//}
//else
//{
...
if (!empty($frmchk_details['password']) || !empty($frmchk_details['password2']))
{

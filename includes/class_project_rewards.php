            ...
            <script>
                ...
                tinymce.init({
                    ...
                    style_formats: [
                        ...
                        {title: 'Header 1', block: 'span', styles: {color: '#444', font: "22px OpenSans, sans-serif", margin: '0 0 1em 0'}},
                        {title: 'Header 2', block: 'span', styles: {color: '#444', font: "bold 18px OpenSans, sans-serif", margin: '0 0 1em 0'}}

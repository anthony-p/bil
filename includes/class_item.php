...
class item extends custom_field
{
	...
	function insert($variables_array, $owner_id, $page_handle = 'auction', $draft = false, $admin_edit = false)
	{
		...
		$sql_insert_item = $this->query("UPDATE " . DB_PREFIX . "auctions SET
			...
			is_draft='" . $is_draft . "', item_weight='" . intval($item_details['item_weight']) . "', 
			...
			npuser_id='" . $item_details['npuser_id'] . "'  
	...
	function insert_wanted_ad($variables_array, $owner_id, $page_handle = 'wanted_ad', $edit = false)
	{
		...
		$sql_insert_item = $this->query("UPDATE " . DB_PREFIX . "wanted_ads SET
			...
			creation_in_progress='0', state='" . $item_details['state'] . "',  npuser_id='" . $item_details['npuser_id'] . "'  
	...
	function assign_winner($item_details, $sale_type = 'high_bid', $buyer_id = 0, $purchased_quantity = 0, $offer_details = null, $force_payment = 0)
	{
		...
		switch ($sale_type)
		{
			...
			case 'buy_out': ## buyer_id is the winner of the auction - wont work with "manually select winner"
				...
				$sql_insert_winner = $this->query("INSERT INTO " . DB_PREFIX . "winners
					(seller_id, buyer_id, bid_amount, quantity_requested, quantity_offered, auction_id, purchase_date, buyout_purchase, temp_purchase, sc_id) VALUES
					('" . $item_details['owner_id'] . "', '" . $buyer_id . "', '" . $item_details['buyout_price'] . "',
					'" . $purchased_quantity . "', '" . $quantity_offered . "', '" . $item_details['auction_id'] . "',
					'" . CURRENT_TIME . "', '1', '" . $force_payment . "', '" . $this->sc_id . "')");
	...
	function delete_cart($sc_id, $option, $user_id)
	{
		if ($option == 'seller')
		{
			$update_field = 's_deleted';
		...
		$this->query("UPDATE " . DB_PREFIX . "shopping_carts SET " . $update_field . "=1 WHERE
			" . $where_field . "='" . $user_id . "' AND sc_id='" . $sc_id . "'");
	}	
}
?>

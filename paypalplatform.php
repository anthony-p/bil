...
$select_query = "SELECT * FROM payment_option_details WHERE payment_method='paypal' AND active=1";

$select_result = $db->get_sql_row(
    $select_query
);

$result = explodeAccessData($select_result);

//var_dump($select_result); exit;

$Env = $result["payment_environment"];
//$Env = "sandbox";
...
//$API_UserName = "rlpc.test-facilitator_api1.gmail.com";
$API_Password = $result["API_Password"];
//$API_Password = "1369165875";
$API_Signature = $result["API_Signature"];
//$API_Signature = "Aso55Q11kxCA5n5zTFSUpO3oiKshAodhJa90x3KMMAy56DxGM8KyQ1-u";

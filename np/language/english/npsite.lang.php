...
define ('MSG_MEMBERS_AREA_TITLE', 'NON PROFIT ORGANIZATION MEMBERS AREA');
...
define ('MSG_REGISTRATION', 'Create a new campaign');
...
define ('MSG_CREATE_PROJECT_CAMPAIGN_BASIC_EXPLANATION', 'What do you want everyone to know about your campaign? Enter all the details here.');
...
define ('MSG_REGISTRATION_MSG', 'Enroll Your Non Profit Organization Now!');
define ('MSG_REGISTER_FOR_ACCOUNT', 'Start fundraising');
define ('MSG_ALREADY_A', 'Already a');
define ('MSG_USER', 'member organization');
...
define ('MSG_ACCOUNT_ACTIVATION_EMAIL_CONFIRM', 'You will need to click on the enrollment confirmation link from the email<br>you have received when you enrolled with our site in order to activate your account');
...
define ('MSG_REGISTER_AS_DESC', 'Please indicate what type of organization you are enrolling');
...
define ('MSG_ADD_TAX_EXPL', 'If you enable this option, your local tax will be applied to the price of this item. If direct payment is enabled, the tax will only be applied to the sale price, and not to the shipping and insuranceprices.');
...
define ('MSG_PHONE_USER_SUBMITTED', 'Phone (optional)');
...
define ('MSG_MEMBER_TIPS_A', 'Tip: Review your <a href="npmembers_area.php?page=selling&section=prefilled_fields">global/prefilled fields</a> settings');
define ('MSG_MEMBER_TIPS_B', 'Selling?  Set up your <a href="npmembers_area.php?page=selling&section=postage_setup">postage options</a> now.');
...
define ('AMSG_URL', 'Project web address');
define ('AMSG_FACEBOOK_URL', 'Facebook page');
define ('AMSG_TWITTER_URL', 'Twitter page');
...
define('AMSG_GIVEBACK_POINTS', 'Giveback Points');
define('AMSG_GIVEBACK_CONVERSION', 'Giveback Conversion Rate');
...
define ('AMSG_PPB_PPA_INTEGRATION', 'PHP Pro Bid & PHP Pro Ads Integration');
define ('AMSG_PPA_RELATIVE_URL', 'PHP Pro Ads Relative Installation URL');
define ('AMSG_PPA_RELATIVE_URL_EXPL', 'Please enter the relative URL of your PHP Pro Ads installation (for example <b>classifieds/</b> - trailing slash mandatory).');
define ('AMSG_PPA_URL_ERROR', 'Error: The relative path to PHP Pro Ads that you have provided is invalid.<br>Please provide a valid URL in order to proceed with the integration');
define ('AMSG_PPA_INTEGRATION_SETTINGS', 'Integration Settings');

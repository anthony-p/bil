		...
		if ($_REQUEST['operation'] == 'submit')
		{
			...
			else
			{
				...
				else if ($setts['signup_settings'] == 2)
				{
					...
					$mail_input_id = $user_id;
					include('language/' . $setts['site_lang'] . '/mails/npregister_approval_user_notification.php');
					include('language/' . $setts['site_lang'] . '/mails/npregister_approval_admin_notification.php');
				}
				else
				{
					// instant activation

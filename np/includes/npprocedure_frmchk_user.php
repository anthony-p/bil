...
if (isset($frmchk_details["pg_paypal_email"]) ||
    isset($frmchk_details["pg_paypal_email"]) ||
    isset($frmchk_details["pg_paypal_email"])) {
    $fv->check_box($frmchk_details['pg_paypal_email'], MSG_PG_PAYPAL_EMAIL_ADDRESS, array('field_empty', 'is_paypal_email_address'));
...
if (!$frmchk_user_edit)
{
	...
	$fv->check_box($frmchk_details['username'], MSG_CREATE_PROJECT_URL, array('field_empty', 'field_html', 'not_url'));
}

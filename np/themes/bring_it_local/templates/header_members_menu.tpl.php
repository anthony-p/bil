...
<table border="0" cellpadding="3" cellspacing="3" width="100%" class="c1 border contentfont">
   ...
   <tr>
      <td class="c2">
      	...
      	<? } ?>
      	&raquo; <a href="<?=process_link('members_area', array('page' => 'bidding', 'section' => 'keywords_watch'));?>"><?=MSG_MM_KEYWORDS_WATCH;?></a>
      </td>
	</tr>
	<? if ($is_seller) { ?>
   <tr>
   ...
   <tr>
      <td class="c2">
      	&raquo; <a href="<?=process_link('members_area', array('page' => 'store', 'section' => 'subscription'));?>"><?=MSG_MM_SUBSCRIPTION_SETUP;?></a><br>

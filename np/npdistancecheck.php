...
//create a form to pass the address variables that are hardcoded below


<form method="post"  action="<?php echo $PHP_SELF;?>">

Address <input name="address" type="text" id="address" value="1113 channing way" size="40" /><br>
City  <input name="city" type="text" id="city" value="berkeley" size="40" /><br>
Zipcode <input name="zipcode" type="text" id="zipcode" value="94702" size="40" /><br><br>     

How far should we search: <input name="distancefrom" type="text" id="distancefrom" value="20" size="2" /> miles <br>  
Limit results to <input name="limitresults" type="text" id="limitresults" value="25" size="2" /> organizations  <br> 

<input name="submit" type="submit" id="form_register_proceed" value="submit" />
<br><br><br>


<?
// create address variables for testing to send to geocode function as parameters
//then when this is working the last step will be to create the form that creates 
//and passes these values to this script

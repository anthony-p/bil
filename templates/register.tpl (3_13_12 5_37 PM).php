...
<form action="<?=$register_post_url;?>" method="post" name="registration_form">
   ...
   <table width="100%" border="0" cellpadding="3" cellspacing="2" class="border">
      ...
      <tr class="c1">
         <td width="150" align="right" class="contentfont"><?=MSG_FIRST_NAME;?> *</td>
         <td class="contentfont"><input name="fname" type="text" id="fname" value="<?=$user_details['fname'];?>" size="40" /></td>
      </tr>
      <tr class="reguser">
        <td>&nbsp;</td>
      ...
      <tr class="c1">
        <td width="150" align="right" class="contentfont"><?=MSG_LAST_NAME;?> *</td>
        <td class="contentfont"><input name="lname" type="text" id="lname" value="<?=$user_details['lname'];?>" size="40" /></td>
      </tr>
      <tr class="reguser">
         <td>&nbsp;</td>

...
<table  border="0" cellpadding="3" cellspacing="2" class="border ">
   <tr>
   ...
   <tr>
      <td></td>
      <td></td>
      <td class="c1"><b><?=GMSG_MAX_DEBIT;?></b></td>
   ...
   <form action="fee_payment.php" method="GET">
      ...
      <tr valign="top">
         <td></td>
         <td></td>
         <td colspan="2"><table class="border"  cellpadding="3" cellspacing="2">
               <tr>
...
<form action="" method="post" name="manage_account_form">
   ...
   <table  border="0" cellpadding="3" cellspacing="2" class="border ">
      ...
      <tr class="c1"> 
			<td nowrap="nowrap"><?=MSG_ENTER_BANK_DETAILS;?></td>
			<td><textarea name="default_bank_details" style="width=100%; height: 100px;"><?=$user_details['default_bank_details'];?></textarea></td>
		</tr> 
		<tr> 
			<td></td> 
	...
	<br>
	<? } ?>
   <table  border="0" cellpadding="3" cellspacing="2" class="border manage-account">
      <tr>
      ...
      <tr class="c1"> 
			<td nowrap="nowrap"><?=MSG_PAYPAL_ADDRESS_OVERRIDE;?></td>
      ...
      <tr class="c1"> 
			<td nowrap="nowrap"><?=MSG_PAYPAL_FIRST_NAME;?></td>
      ...
      <tr class="c1"> 
			<td nowrap="nowrap"><?=MSG_PAYPAL_LAST_NAME;?></td>
      ...
      <tr class="c1"> 
			<td nowrap="nowrap"><?=MSG_PAYPAL_COUNTRY;?></td>
      ...
      <tr class="c1"> 
			<td nowrap="nowrap"><?=MSG_PAYPAL_STATE;?></td>
			<td><input name="paypal_state" type="text" value="<?=$user_details['paypal_state'];?>" size="25"></td> 
		</tr> 
		<tr class="contentfont"> 
			<td></td> 
		...
		<? } ?>
      <tr class="c1"> 
			<td nowrap="nowrap"><?=MSG_PAYPAL_ADDRESS1;?></td>
      ...
      <tr class="c1"> 
			<td nowrap="nowrap"><?=MSG_PAYPAL_ADDRESS2;?></td>
      ...
      <tr class="c1"> 
			<td nowrap="nowrap"><?=MSG_PAYPAL_CITY;?></td>
      ...
      <tr class="c1"> 
			<td nowrap="nowrap"><?=MSG_PAYPAL_ZIP;?></td>
      ...
      <tr class="c1"> 
			<td nowrap="nowrap"><?=MSG_PAYPAL_PHONE_A;?></td>
      ...
      <tr class="c1"> 
			<td nowrap="nowrap"><?=MSG_PAYPAL_PHONE_B;?></td>
   ...
   <table  border="0" cellpadding="3" cellspacing="2" class="border">
      ...
      <tr>
         <td colspan="2" class="c7" nowrap="nowrap"><b><?=MSG_DIRECT_PAYMENT_SETTINGS;?></b></td>
      </tr>
      <? } ?>
      <tr class="c5">
         <td><img src="themes/<?=$setts['default_theme'];?>/img/pixel.gif" width="150" height="1"></td>

...
<form action="" method="post" name="mailprefs_form">
   ...
   <table width="100%" border="0" cellpadding="3" cellspacing="2" class="border">
      ...
      <tr class="c1">
         <td width="250" nowrap="nowrap"><?=MSG_SENT_MSG_NOTIF;?></td>
         <td colspan="2"><input type="checkbox" name="mail_messaging_sent" value="1" <? echo ($mail_prefs['mail_messaging_sent']==1) ? 'checked' : ''; ?>/></td>
      </tr>
      <tr>
         <td></td>
         <td colspan="2" class="explain" ><?=MSG_SENT_MSG_NOTIF_EXPL;?></td>
      </tr>
      <tr class="c1">
         <td width="250"  nowrap="nowrap"><?=MSG_RECEIVED_MSG_NOTIF;?></td>
      ...
      <tr>
         <td></td>
         <td colspan="2" class="explain" ><?=MSG_RECEIVED_MSG_NOTIF_EXPL;?></td>
      </tr>
      <tr class="c1">
         <td width="250"  nowrap="nowrap"><?=MSG_ITEM_SOLD_NOTIF;?></td>
         <td colspan="2"><input type="checkbox" name="mail_item_sold" value="1" <? echo ($mail_prefs['mail_item_sold']==1) ? 'checked' : ''; ?>/></td>
      </tr>
      <tr>
         <td></td>
         <td colspan="2" class="explain" ><?=MSG_ITEM_SOLD_NOTIF_EXPL;?></td>
      </tr>
      <tr class="c1">
         <td width="250" nowrap="nowrap"><?=MSG_ITEM_WON_NOTIF;?></td>
         <td colspan="2"><input type="checkbox" name="mail_item_won" value="1" <? echo ($mail_prefs['mail_item_won']==1) ? 'checked' : ''; ?>/></td>
      </tr>
      <tr>
         <td></td>
         <td colspan="2" class="explain" ><?=MSG_ITEM_WON_NOTIF_EXPL;?></td>
      </tr>
      <tr class="c1">
         <td width="250"  nowrap="nowrap"><?=MSG_BID_PLACED_NOTIF;?></td>
      ...
      <tr>
         <td></td>
         <td colspan="2" class="explain" ><?=MSG_BID_PLACED_NOTIF_EXPL;?></td>
      </tr>
      <tr class="c1">
         <td width="250"  nowrap="nowrap"><?=MSG_OUTBID_NOTIF;?></td>
         <td colspan="2"><input type="checkbox" name="mail_outbid" value="1" <? echo ($mail_prefs['mail_outbid']==1) ? 'checked' : ''; ?>/></td>
      </tr>
      <tr>
         <td></td>
         <td colspan="2" class="explain" ><?=MSG_OUTBID_NOTIF_EXPL;?></td>
      </tr>
      <tr class="c1">
         <td width="250" nowrap="nowrap"><?=MSG_CONFIRM_TO_SELLER_NOTIF;?></td>
         <td colspan="2"><input type="checkbox" name="mail_confirm_to_seller" value="1" <? echo ($mail_prefs['mail_confirm_to_seller']==1) ? 'checked' : ''; ?>/></td>
      </tr>
      <tr>
         <td></td>
         <td colspan="2" class="explain" ><?=MSG_CONFIRM_TO_SELLER_NOTIF_EXPL;?></td>
      </tr>
      <tr class="c1">
         <td width="250"  nowrap="nowrap"><?=MSG_ITEM_CLOSED_NOTIF;?></td>
         <td colspan="2"><input type="checkbox" name="mail_item_closed" value="1" <? echo ($mail_prefs['mail_item_closed']==1) ? 'checked' : ''; ?>/></td>
      </tr>
      <tr>
         <td></td>
         <td colspan="2" class="explain" ><?=MSG_ITEM_CLOSED_NOTIF_EXPL;?></td>
      </tr>
      <tr class="c5">
         <td><img src="themes/<?=$setts['default_theme'];?>/img/pixel.gif" width="1" height="1"></td>
         <td colspan="2" class="explain" ><img src="themes/<?=$setts['default_theme'];?>/img/pixel.gif" width="1" height="1"></td>
      </tr>
      <tr>
         <td></td>

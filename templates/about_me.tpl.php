        ...
        <div class="summary-block clrfix">
            ...
            <span
                ...
                <div class="social-block">
                    ...
                    <?php endif; ?>
                    <?php if (!empty($user_details['twitter_link']) &&$user_details['twitter_link'] != 'http://www.twitter.com/') : ?>
                        <a href="<?= $user_details['twitter_link'] ?>" target="_blank">
                            <span class="social-icon inline-block twitter"></span>
                        </a>
                    <?php endif; ?>
                    <?php if (!empty($user_details['google_link']) &&$user_details['google_link'] != 'https://plus.google.com/') : ?>

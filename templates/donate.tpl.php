...
<!--    </div>-->
    <div class="right">
        ...
        <div class="donate_block">
            ...
            <div class="clear"></div>
            <br /> <br />
            <input id="submit" type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_donateCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!" style="float: right">

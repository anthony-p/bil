...
<table width="100%" border="0" cellpadding="3" cellspacing="2">
   ...
   <? } ?>
   <? if ($reverse_fees['second_cat_fee']>0) { ?>
   <tr class="c2">
      <td align="right" width="50%"><strong>
         <?=GMSG_ADDLCAT_FEE;?>
         </strong></td>
   ...
   <? } ?>
   <? if ($reverse_fees['bolditem_fee']>0) { ?>
   <tr class="c2">
      <td align="right" width="50%"><strong>
         <?=GMSG_BOLD_FEE;?>
         </strong></td>
   ...
   <? } ?>
   <? if ($reverse_fees['custom_start_fee']>0) { ?>
   <tr class="c2">
      <td align="right" width="50%"><strong>
         <?=GMSG_CUSTOM_START_FEE;?>
         </strong></td>

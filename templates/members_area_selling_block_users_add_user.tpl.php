...
<table width="100%" border="0" cellpadding="3" cellspacing="2" class="border add-users">
   <tr>
   ...
   <form action="members_area.php?page=selling&section=block_users" method="post">
      ...
      <tr class="c1">
         <td nowrap="nowrap"><?=MSG_USERNAME;?></td>
      ...
      -->
      <tr class="c1">
         <td nowrap="nowrap"><?=MSG_BLOCK_REASON;?></td>
         <td colspan="2" ><textarea name="block_reason" style="width: 80%; height: 300" id="block_reason"><?=$post_details['block_reason'];?></textarea></td>
      </tr>
      <tr class="c1">
         <td nowrap="nowrap"><?=MSG_SHOW_REASON;?></td>

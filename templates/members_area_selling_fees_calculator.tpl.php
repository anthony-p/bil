...
<? } ?>
<br>
<table width="100%" border="0" cellpadding="3" cellspacing="2" class="border calculator_form">
   <form action="" method="post" name="fees_calculator_form">
      ...
      <tr class="c1">
         <td width="150"><?=MSG_AUCTION_STARTS_AT;?></td>

...
<table width="100%" border="0" cellpadding="3" cellspacing="2" class="border">
   ...
   <tr>
      ...
      <td class="membmenu"><?=MSG_SHOW_REASON;?></td>
      <td class="membmenu""><?=MSG_BLOCK;?></td>
      <td class="membmenu" class="contentfont"><?=GMSG_OPTIONS;?></td>
   </tr>
   <tr class="c5">
   ...
   <? if ($nb_items>0) { ?>
   <tr>
      <td colspan="5"class="contentfont"><?=$pagination;?></td>
   </tr>
	<? } ?>
   <tr class="c4">

...
<form action="members_area.php?page=about_me&section=profile" method="POST">
   <table width="100%" border="0" cellpadding="3" cellspacing="2" class="border">
      ...
      <tr class="c1">
         <td nowrap="nowrap"><?=MSG_ENABLE_PROFILE_PAGE;?></td>

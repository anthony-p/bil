...
<form action="<?=$register_post_url;?>" method="post" name="registration_form" class="registrationForm">
    ...
    <div class="form-cont">
        <div class="form-row">
            ...
            <input name="fname" type="text" id="fname" class="text"value="<?=$user_details['fname'];?>" size="40" />
            <input name="affiliate" type="hidden" class="text" id="affiliate" value="<?=$_POST['affiliate'];?>" size="40" />
        </div>
        <div class="form-row">
            <label><?=MSG_LAST_NAME;?>*</label>
            <input name="lname" type="text" id="lname"  class="text"  value="<?=$user_details['lname'];?>" size="40"/>
        </div>

        <div class="form-row">
            <label><?=MSG_EMAIL_ADDRESS;?>*</label>
            <input name="email" type="text" class="contentfont text" id="email"  value="<?=$user_details['email'];?>" size="40" maxlength="120" <? echo (IN_ADMIN == 1) ? 'onchange="copy_email_value();"' : ''; ?> />
        ...
        <div class="form-row">
            ...
            <input name="email_check" type="text" class="contentfont text" id="email_check"value="<?=$email_check_value;?>" size="40" maxlength="120" onkeyup="checkEmail();">
            <img src="<?=$path_relative;?>themes/<?=$setts['default_theme'];?>/img/system/check_img.gif" id="email_img" align="absmiddle" style="display:none;" />
        </div>


        <div class="form-row">
           <label> <?=MSG_PASSWORD;?>*</label>
            <input name="password" type="password" class="contentfont text" id="password"  value="" size="40" maxlength="120" <? echo (IN_ADMIN == 1) ? 'onchange="copy_password_value();"' : ''; ?> />
        ...
        <div class="form-row">
           ...
           <input name="password2" type="password" class="contentfont text"  id="password2" value="" size="40" maxlength="120" onkeyup="checkPass();" class="text" >
                <img src="<?=$path_relative;?>themes/<?=$setts['default_theme'];?>/img/system/check_img.gif" id="pass_img" align="absmiddle" style="display:none;" />
        </div>

...
<!--    </div>-->
    ...
    <form id="search_by_name" accept="#">
        <select id="order_result" name="order" class="changeMe">
            <option value="" selected="selected" class="order">Sort by</option>
        ...
        <li id="li_<?php echo $row["user_id"]?>">
            ...
            <fieldset>
                <div class="campaignsButtons">
                    ...
                    <a href="/campaigns,page,edit,section,<?php echo $row["user_id"]?>,campaign_id,members_area?keyword=#<?php echo $row['user_id'];?>;?>" class="edit">edit</a>

...
<table width="80%" border="2" cellpadding="0" cellspacing="0" class="border contentfont">
   <tr>
...
<!-- 
   <tr>
      <td colspan="5" class="title"><b>111
 ...
 -->
   ...
   <?
	...
	$post_url = ($option == 'category_search') ? 'global_partners.php' : $post_url;
	?>
   <form action="<?=$post_url;?>" method="POST" name="form_advanced_search">
      ...
      <tr>
		<td colspan="5" style="width:100%; "><input name="keywords_cat_search" type="text" id="shop_name" size="50" onfocus="if (this.value=='<?=$search_options_title;?>') {this.value=''}" onblur="if(this.value==''){this.value='<?=$search_options_title;?>'}" value="<?=$search_options_title;?>">
			<span style="float:left; font: 13px/26px OpenSans; margin: 0 10px;">&nbsp;<?=GMSG_IN;?>&nbsp;</span> <?=$cats_src_drop_down;?>
			<input type="hidden" name="search_description" value="1">
			<input type="submit" name="form_search_proceed" id="form_search_proceed" value="<?=GMSG_SEARCH;?>">	
		</td>
      </tr>

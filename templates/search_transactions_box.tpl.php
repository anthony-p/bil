...
<br>
<table width="100%" border="0" cellpadding="3" cellspacing="2" class="border search-transaction ">
   <tr>
   ...
   <form action="members_area.php" method="post" name="search_transactions_form">   	
      ...
      <tr class="c1">
         <td nowrap="nowrap"><?=MSG_AUCTION_ID;?></td>
      ...
      <tr class="c1">
         <td style="white-space: nowrap;"><?=MSG_SELECT_PERIOD;?></td>

...
<?=$page_meta_tags;?>
<link rel="shortcut icon" href="http://dev.bringitlocal.com/images/favicon.ico" />
...
<!--			<li><a href="<?=$integration['ppa_url'];?>"><?=MSG_BTN_CLASSIFIEDS;?></a></li>-->
			<? } ?>
 <li><span style="position:relative; right:-300px;"><a href="/np/nplogin.php">Schools and non profits: enroll here!</a></span></li>

...
<table border="0" cellpadding="3" cellspacing="0" width="100%" class="submembmenu">
   <tr>
   	...
   	<td nowrap <?=(($section == 'purchased_carts') ? 'class="subcell_a"' : 'class="subcell_u"');?>><a href="<?=process_link('members_area', array('page' => 'bidding', 'section' => 'purchased_carts'));?>">
         <?=MSG_MM_PURCHASED_CARTS;?></a></td>
		<? } ?>
      ...
      <? } ?>
   	...
   	<td nowrap <?=(($section == 'sold') ? 'class="subcell_a"' : 'class="subcell_u"');?>><a href="<?=process_link('members_area', array('page' => 'selling', 'section' => 'sold'));?>">
         <?=MSG_MM_SOLD;?></a></td>
      <? if ($setts['enable_stores']) { ?>
   	<td nowrap <?=(($section == 'sold_carts') ? 'class="subcell_a"' : 'class="subcell_u"');?>><a href="<?=process_link('members_area', array('page' => 'selling', 'section' => 'sold_carts'));?>">
         <?=MSG_MM_SOLD_CARTS;?></a></td>
      <? } ?>
...
<table border="0" cellpadding="3" cellspacing="0" width="100%">
	<tr>
      ...
      <? } ?>
   	...
   	<td nowrap <?=(($section == 'postage') ? 'class="subcell_a"' : 'class="subcell_u"');?>><a href="<?=process_link('members_area', array('page' => 'store', 'section' => 'postage'));?>">
         <?=MSG_MM_SC_SETTS;?></a></td>

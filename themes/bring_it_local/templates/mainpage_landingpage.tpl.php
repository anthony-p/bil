...
<!--		<div class="row clearfix">-->
			...
			<div class="block">
				<?
                    ...
                    <a href="<?=$auction<script src="/scripts/jquery/easyResponsiveTabs.js"_link;?>" class="image"><img src="<? echo ((!empty($main_image)) ? 'thumbnail.php?pic=' . $main_image . '&w=' . $layout['hpfeat_width'] . '&sq=Y' : 'themes/' . $setts['default_theme'] . '/img/system/noimg.gif');?>" border="0" alt="<?=$item_localdetails[$counter]['name'];?>"></a>
